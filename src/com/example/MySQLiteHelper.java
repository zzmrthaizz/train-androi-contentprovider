...
//		 db.close();
	...
	public Cursor getPhongBan() {
		...
		Cursor cursor = db.query(PBAN_TABLE, allcolumes, null,
				null, null, null, null);
		if (cursor != null) {
			cursor.moveToFirst();
		}
	...
	public void deletePhongBan(PhongBan phongBan) {
		SQLiteDatabase db = this.getWritableDatabase();
		String selection = COL_MAPHONG+" = \"" + phongBan.getMaPhong() + "\"";
		int rowsDeleted = myCR.delete(MyProvider.PBAN_URI, selection, null);
